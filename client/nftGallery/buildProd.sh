# This script will either run or build APK/AAB for PROD
    ...
    then 
        ...
        then
            ...
            then
                ...
                echo "Building APK"
                echo "**************************"
                flutter build apk --flavor PROD -t lib/main.dart --build-name=$2 --build-number=$3
            else 
                echo "**************************"
                echo "Building AAB"
                echo "**************************"
                flutter build appbundle --release --flavor PROD -t lib/main.dart --build-name=$2 --build-number=$3
            fi
        fi
    elif [ $1 == "ios" ]
    then
