# This script will either run or build APK/AAB for UAT
    ...
    then 
        ...
        then
            ...
            then
                ...
                echo "Building APK"
                echo "**************************"
                flutter build apk --flavor UAT -t lib/main_uat.dart --build-name=$2 --build-number=$3
            else 
                echo "**************************"
                echo "Building AAB"
                echo "**************************"
                flutter build appbundle --release --flavor UAT -t lib/main_uat.dart --build-name=$2 --build-number=$3
            fi
        fi
    elif [ $1 == "ios" ]
    then
